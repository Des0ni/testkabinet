...
function startSession(list) {
    ...
    if ((fn === 'opbd.json' || fn === 'evm.json' || fn === 'mdk_01_01.json' || fn === 'english_2.json' || fn === 'mdk_01_01.json' || fn === 'mdk_01_04.json' ||  fn === 'probability.json' ||  fn === 'discrete_math.json') && (md === 'review' || md === 'test-cabinet')) {
