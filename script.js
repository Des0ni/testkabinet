...
function startSession(list) {
    ...
    if ((fn === 'osn_alg.json' || fn === 'it.json' || fn === 'it_project_management.json' || fn === 'mdk_03_01.json' || fn === 'mdk_03_02.json' || fn === 'history.json' || fn === 'psychology.json' || fn === 'mdk_01_01.json' || fn === 'history_russia.json' || fn === 'geography.json' || fn === 'opbd.json' || fn === 'evm.json' || fn === 'mdk_01_01.json' || fn === 'english_2.json' || fn === 'mdk_01_01.json' || fn === 'mdk_01_04.json' ||  fn === 'probability.json' ||  fn === 'discrete_math.json') && (md === 'review' || md === 'test-cabinet')) {
